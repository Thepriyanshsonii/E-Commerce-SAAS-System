...
# Enable CORS — restrict to the configured frontend origin for this environment.
# Set ALLOWED_ORIGIN in your .env file (e.g. https://your-app.vercel.app).
_allowed_origins = [o.strip() for o in app.config.get("ALLOWED_ORIGIN", "").split(",") if o.strip()]
