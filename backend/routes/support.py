...
DEFAULT_FAQS = [
    {
        "question": "What is BharatBasket?",
        "answer": "BharatBasket is a modern e-commerce site where you can buy daily essentials, groceries, electronics, and fashion items, inspired by Flipkart and Amazon."
    },
    {
        "question": "How do I track my order?",
        "answer": "Go to the 'My Orders' tab in the navbar. You will see the delivery status, purchase details, and estimated delivery dates for all your orders."
    },
    {
        "question": "What is the OTP verification during checkout?",
        "answer": "To secure your transaction, we send a 6-digit OTP code to your registered mobile/email. Enter this OTP during checkout to complete your order."
    },
    {
        "question": "Is cash on delivery available?",
        "answer": "Currently, we only support placing simulated orders with secure digital profiles and OTP checks. No actual credit card integrations are required."
    },
    {
...
DEFAULT_SUPPORT_LINKS = [
    ...
    {
        "title": "support@bharatbasket.com",
        "url": "mailto:support@bharatbasket.com",
        "icon": "Mail"
    },
    {
